...
const OwnSpPaymentMethod = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axiosPublic.post("/own-sp-payment/user", paymentData);
      if (res.data.id) navigate("/own-sp-payment-success");
...
export default OwnSpPaymentMethod;
