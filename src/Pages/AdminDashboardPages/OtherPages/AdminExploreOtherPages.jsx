...
import AdminExploreOtherEditPages from "./AdminExploreOtherEditPages";

const AdminExploreOtherPages = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => axiosPublic.put(`/own-sp/explore/${id}`, data),
    onSuccess: () => {
  ...
  const createMutation = useMutation({
    mutationFn: (newData) => axiosPublic.post("/own-sp/explore", newData),
    onSuccess: () => {
      queryClient.invalidateQueries(["OwnSpOther"]);
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => axiosPublic.delete(`/own-sp/explore/${id}`),
    onSuccess: (res) => {
...
export default AdminExploreOtherPages;
