...
const InterviewsQustionsExcersice = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/third-layer/getAllExerciseInterviewQuestions"
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(
        `/third-layer/deleteExerciseInterviewQuestions/${id}`
      ),
    onSuccess: () => {
      Swal.fire(
        "Deleted!",
...
export default InterviewsQustionsExcersice;
