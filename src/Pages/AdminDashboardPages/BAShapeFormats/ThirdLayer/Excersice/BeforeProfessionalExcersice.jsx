...
const BeforeProfessionalExcersice = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/third-layer/getAllExerciseBeforeProfessional"
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(
        `/third-layer/deleteExerciseBeforeProfessional/${id}`
      ),
    onSuccess: () => {
      Swal.fire(
        "Deleted!",
...
export default BeforeProfessionalExcersice;
