...
const DevelopYourSkillsExcersice = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/third-layer/getAllExerciseDevelopSkills",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/third-layer/deleteExerciseDevelopSkills/${id}`),
    onSuccess: () => {
      Swal.fire(
        "Deleted!",
...
export default DevelopYourSkillsExcersice;
