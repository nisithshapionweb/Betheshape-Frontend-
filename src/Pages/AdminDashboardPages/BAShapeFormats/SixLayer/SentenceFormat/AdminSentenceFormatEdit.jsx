...
const AdminSentenceFormatEdit = () => {
  ...
  const { data: sentence, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(`/six-layer/sentence/${id}`);
      return res.data.data;
    },
  });
 ...
 const onSubmit = async (data) => {
  try {
    await axiosPublic.put(`/six-layer/sentence/${id}`, data);
...
export default AdminSentenceFormatEdit;
