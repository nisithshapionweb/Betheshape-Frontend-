...
const AdminVocabularyFormatEdit = () => {
  const { id } = useParams();
  ...
  const { data: vocabulary, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(`/six-layer/vocabulary/${id}`);
      return res.data.data;
    },
  });
 ...
 const onSubmit = async (data) => {
  try {
    await axiosPublic.put(`/six-layer/vocabulary/${id}`, data);
...
export default AdminVocabularyFormatEdit;
