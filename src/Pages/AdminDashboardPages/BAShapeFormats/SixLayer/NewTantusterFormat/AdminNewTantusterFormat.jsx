...
import AdminNewTantusterFormatModal from "./AdminNewTantusterFormatModal";

const AdminNewTantusterFormat = () => {
  ...
  const { mutateAsync: createnewtantuster } = useMutation({
    mutationFn: async (newData) => {
      const res = await axiosPublic.post("/six-layer/newtantuster", newData);
      return res.data;
    },
    onSuccess: () => {
  ...
  const { mutateAsync: deletenewtantuster } = useMutation({
    mutationFn: async (id) => {
      const res = await axiosPublic.delete(`/six-layer/newtantuster/${id}`);
      return res.data;
    },
    onSuccess: () => {
  ...
  const toggleIsActiveMutation = useMutation({
    mutationFn: async (currentState) => {
      const res = await axiosPublic.put(`/six-layer/newtantusterField/toggle`, {
...
export default AdminNewTantusterFormat;
