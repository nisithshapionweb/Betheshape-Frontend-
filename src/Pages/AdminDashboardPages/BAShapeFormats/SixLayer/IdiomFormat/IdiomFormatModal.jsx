...
const IdiomFormatModal = ({ isOpen, onClose, fieldName, currentValue, vocabId }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (newValue) => {
      const res = await fetch(
        `https://api.betheshape.com/six-layer/idiomField/${vocabId}`,
        {
          method: "PUT",
...
export default IdiomFormatModal;
