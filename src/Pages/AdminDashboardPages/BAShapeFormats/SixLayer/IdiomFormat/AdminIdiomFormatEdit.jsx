...
const AdminIdiomFormatEdit = () => {
  ...
  const { data: idiom, isLoading } = useQuery({
    queryKey: ["idiom", id],
    queryFn: async () => {
      const res = await axiosPublic.get(`/six-layer/idiom/${id}`);
      return res.data.data;
    },
  });
 ...
 const onSubmit = async (data) => {
  try {
    await axiosPublic.put(`/six-layer/idiom/${id}`, data);
...
export default AdminIdiomFormatEdit;
