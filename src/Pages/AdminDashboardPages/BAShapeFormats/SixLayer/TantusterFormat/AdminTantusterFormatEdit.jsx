...
const AdminTantusterFormatEdit = () => {
  const { id } = useParams();
  ...
  const { data: tantuster, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(`/six-layer/tantuster/${id}`);
      return res.data.data;
    },
  });
 ...
 const onSubmit = async (data) => {
  try {
    await axiosPublic.put(`/six-layer/tantuster/${id}`, data);
...
export default AdminTantusterFormatEdit;
