...
import TantusterFormatModal from "./TantusterFormatModal";



const AdminTantusterFormat = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get("/six-layer/tantusterField");
  ...
  const { mutateAsync: createtantuster } = useMutation({
    mutationFn: async (newData) => {
      const res = await axiosPublic.post("/six-layer/tantuster", newData);
      return res.data;
    },
    onSuccess: () => {
  ...
  const {
    ...
    queryKey: ["tantuster"],
    queryFn: async () => {
      const res = await axiosPublic.get("/six-layer/tantuster");
      return res.data.data || [];
    },
  });
  ...
  const { mutateAsync: deletetantuster } = useMutation({
    mutationFn: async (id) => {
      const res = await axiosPublic.delete(`/six-layer/tantuster/${id}`);
      return res.data;
    },
    onSuccess: () => {
  ...
  const toggleIsActiveMutation = useMutation({
    mutationFn: async (currentState) => {
      const res = await axiosPublic.put(`/six-layer/tantusterField/toggle`, {
...
export default AdminTantusterFormat;
