...
const AdminTenseFormatEdit = () => {
  ...
  const { data: tense, isLoading } = useQuery({
    queryKey: ["tense", id],
    queryFn: async () => {
      const res = await axiosPublic.get(`/six-layer/tense/${id}`);
      return res.data.data;
    },
  });
 ...
 const onSubmit = async (data) => {
  try {
    await axiosPublic.put(`/six-layer/tense/${id}`, data);
...
export default AdminTenseFormatEdit;
