...
const BeforeProfessionalFormatModal = ({ isOpen, onClose, fieldName, currentValue, vocabId }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (newValue) => {
      const res = await fetch(
        `https://api.betheshape.com/six-layer/beforeProfessionalField/${vocabId}`,
        {
          method: "PUT",
...
export default BeforeProfessionalFormatModal;
