...
const TantusterFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/six-layer/getAllExerciseTantuster",
      );
  ...
  const { mutateAsync: deleteExercise } = useMutation({
    mutationFn: async (id) =>
      axiosPublic.delete(`/six-layer/deleteExerciseTantuster/${id}`),
    onSuccess: () => {
...
export default TantusterFormatExercise;
