...
const NewTantusterFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/six-layer/getAllExerciseNewTantuster",
      );
  ...
  const { mutateAsync: deleteExercise } = useMutation({
    mutationFn: async (id) =>
      axiosPublic.delete(`/six-layer/deleteExerciseNewTantuster/${id}`),
    onSuccess: () => {
...
export default NewTantusterFormatExercise;
