...
const IdeaShareFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/six-layer/getAllExerciseIdeaShares",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/six-layer/deleteExerciseIdeaShares/${id}`),
    onSuccess: () => {
...
export default IdeaShareFormatExercise;
