...
const GoodLifeStyleFormatExcersice = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/six-layer/getAllExerciseGoodLifeStyle"
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(
        `/six-layer/deleteExerciseGoodLifeStyle/${id}`
      ),
    onSuccess: () => {
      Swal.fire(
        "Deleted!",
...
export default GoodLifeStyleFormatExcersice;
