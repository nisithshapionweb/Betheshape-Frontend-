...
const GoodMovieFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/seven-layer/getAllExerciseGoodMovie",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/seven-layer/deleteExerciseGoodMovie/${id}`),
    onSuccess: () => {
...
export default GoodMovieFormatExercise;
