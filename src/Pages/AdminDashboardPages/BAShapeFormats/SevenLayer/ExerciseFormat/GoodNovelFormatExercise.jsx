...
const GoodNovelFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/seven-layer/getAllExerciseGoodNobel",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/seven-layer/deleteExerciseGoodNobel/${id}`),
    onSuccess: () => {
...
export default GoodNovelFormatExercise;
