...
const TravelingFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/seven-layer/getAllExerciseTraveling",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/seven-layer/deleteExerciseTraveling/${id}`),
    onSuccess: () => {
...
export default TravelingFormatExercise;
