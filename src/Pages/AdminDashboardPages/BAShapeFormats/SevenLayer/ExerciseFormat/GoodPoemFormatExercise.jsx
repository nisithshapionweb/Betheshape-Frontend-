...
const GoodPoemFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/seven-layer/getAllExerciseGoodPorem",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/seven-layer/deleteExerciseGoodPorem/${id}`),
    onSuccess: () => {
...
export default GoodPoemFormatExercise;
