...
const GoodSongFormatExercise = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axiosPublic.get(
        "/seven-layer/getAllExerciseGoodSong",
      );
  ...
  const { mutate: deleteExercise } = useMutation({
    mutationFn: (id) =>
      axiosPublic.delete(`/seven-layer/deleteExerciseGoodSong/${id}`),
    onSuccess: () => {
...
export default GoodSongFormatExercise;
