...
import StoryWrittingFormatModal from "./StoryWrittingFormatModal";

const AdminStoryWrittingFormat = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (newData) =>
      axiosPublic.post("/seven-layer/storyWriting", newData),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) =>
      axiosPublic.put(`/seven-layer/storyWriting/${id}`, data),
    onSuccess: () => {
      Swal.fire(
        "✅ Updated!",
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => axiosPublic.delete(`/seven-layer/storyWriting/${id}`),
    onSuccess: (res) => {
  ...
  const toggleIsActiveMutation = useMutation({
    mutationFn: async (currentState) => {
      const res = await axiosPublic.put(
        `/seven-layer/storyWritingField/toggle`,
        {
          fieldName: "isActive",
...
export default AdminStoryWrittingFormat;
